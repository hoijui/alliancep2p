...
public class CoreSubsystem implements Subsystem {
    public final static boolean ALLOW_TO_SEND_UPGRADE_TO_FRIENDS = false; //dont' forget to turn off trace, run with registered synthetica, and compile with java 1.5 when releasing a real version.
