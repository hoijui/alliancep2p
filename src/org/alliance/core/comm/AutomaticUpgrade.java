...
public class AutomaticUpgrade {
    ...
    public void performUpgrade() throws Exception {
        ...
        if (fd == null) {
            ...
            if(T.t)T.info("Jar verified! Upgrading...");

            copyFile(new File(fd.getFullPath()), SOURCE_JAR);
            if(T.t)T.info("Upgrade successful! Restarting.");
